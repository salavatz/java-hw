...
public class Main {
    ...
    private static void createTableForLogs() {
        Connection connection = null;
        try {
            connection = ConnectorDB.getConnection();
            Statement statement = connection.createStatement();
            statement.executeUpdate(Queries.createLogsTable);
    ...
    private static void createTable() {
        ...
        try {
            ...
            logger.error("Creating a table failed", e);
        } finally {
            try {
                connection.close();
            } catch (SQLException e) {
                logger.error("Connection closure failed", e);
            }
        }
        logger.info("Table creation completed successfully");
    }

    private static void insertIntoTableWithBatch() {
        Connection connection = null;
        try {
            connection = ConnectorDB.getConnection();
            Statement statement = connection.createStatement();
            ...
            logger.error("Insert into table failed", e);
        } finally {
            try {
                connection.close();
            } catch (SQLException e) {
        ...
        logger.info("Insert into table completed successfully");
    }

    private static void insertIntoTableWithParameters() {
        Connection connection = null;
    ...
    private static void getTableColumns(int login_ID, String name) {
        Connection connection = null;
        ...
        try {
            ...
            logger.error("Retrieving from table failed", e);
        } finally {
            try {
                connection.close();
            } catch (SQLException e) {
        ...
        logger.info("Getting from the table completed successfully");
    }

    private static void transactionWithSavePoints() {
        Connection connection = null;
    ...
    private static void transactionWithSavePointsAndException() {
        Connection connection = null;
        String name = "Billing";
        int id = 2;
        ...
        try {
            ...
            try {
                connection.rollback(savepoint);
                logger.error("Transaction rolled back to savepoint", e);
            } catch (SQLException e1) {
                logger.error("Transaction rollback failed", e);
            }
        }
